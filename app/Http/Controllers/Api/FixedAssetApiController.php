...
class FixedAssetApiController extends Controller
{
    ...
    public function show(FixedAsset $fixedAsset)
    {
        return response()->json([
            'success' => true,
            'data' => $fixedAsset->load(['assetAccount', 'depreciationExpenseAccount', 'accumulatedDepreciationAccount', 'costCenter', 'depreciations']),
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            ...
            'data' => $asset->load(['assetAccount', 'depreciationExpenseAccount', 'accumulatedDepreciationAccount', 'costCenter']),
        ], 201);
    }
    ...
    public function depreciate(Request $request, FixedAsset $fixedAsset)
    {
        ...
        if ($depreciationAmount <= 0) {
            return response()->json([
                'success' => false,
                'message' => 'تم استهلاك هذا الأصل بالكامل مسبقاً أو وصل إلى القيمة التخريدية.',
            ], 422);
        }
        ...
        return response()->json([
            'success' => true,
            'message' => 'تم احتساب قسط الإهلاك وتوليد القيد المحاسبي بنجاح',
            'data' => $fixedAsset->fresh(['depreciations']),
        ]);
    }
    ...
    public function destroy(FixedAsset $fixedAsset)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'تم حذف الأصل الثابت وسجل إهلاكاته بنجاح',
        ]);
    }
}
