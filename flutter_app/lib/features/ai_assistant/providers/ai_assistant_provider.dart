    ...
    if (_messages.isEmpty) {
      _messages.add(
        AiMessage(
          ...
          text: 'مرحباً بك! أنا المساعد المحاسبي الذكي 🤖✨.\nيمكنك سؤالي عن التقارير المالية والأرباح، أو توجيه أوامر لإنشاء فواتير، سندات قبض وصرف، قيود يومية، أو استعراض أصناف المستودع وعملاء النظام فوراً.\n\nتفضل باختيار نموذجك المفضل (ChatGPT, Gemini, Groq) وأدخل مفتاح API الخاص بك من الإعدادات للبدء.',
