    ...
    if (_messages.isEmpty) {
      _messages.add(
        AiMessage(
          ...
          text: 'مرحباً بك يا باشمهندس محمود! 👋 أنا **« غباء (Ghabaa AI) »** مساعدك المحاسبي الذكي 🤖💼.\n\nيمكنك مناداتي في أي وقت بـ **"يا غباء"** وطلب أي عملية مالية أو استعلام (سندات، فواتير، تقارير أرباح، أصناف المستودع، عملاء، أو اتصال صوتي مباشر).\n\nشو حابب نسوي اليوم؟ ✨',
